...
src/
  ...
  index.css
Usage
Add a Contract – fill in employee details and contract dates.
Edit a Contract – click “Edit” on a contract card.
Delete a Contract – click “Delete” on a contract card, with confirmation.
Filter & Search – combine search and filter to quickly find contracts.
View Summary Cards – see an overview of contract statuses at a glance.
Future Enhancements
